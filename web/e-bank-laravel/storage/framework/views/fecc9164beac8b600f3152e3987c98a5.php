  ...
  <body>
    <div class="form-login">
      <div class="login-card">
        <form action="<?php echo e(route('submit_sign_up')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <!-- konten 1 -->
            <div class="content-1">
...
<?php /**PATH C:\Users\umaru\OneDrive\Documents\Budiluhur\studpen\it-perbankan-finpro-kelompok10\web\e-bank-laravel\resources\views/sign_up.blade.php ENDPATH**/ ?>
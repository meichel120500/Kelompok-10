      ...
      <div class="main-menu">
        ...
        <div class="menu-dashboard">
          ...
          <div class="saldo-user">
            <h2>Saldo Terakhir Anda<br /><span>Rp. <?php echo e($bank->nilai_saldo ?? "-"); ?></span></h2>
          </div>
          <div class="dashboard-items">
            <div class="transfer-uang">
              <h2>Total Transfer Uang<br /><span>Rp. <?php echo e($total_transfer); ?></span></h2>
            </div>
            <div class="total-pendapatan">
              <h2>Total Pendapatan Uang<br /><span>Rp. <?php echo e($total_pendapatan); ?></span></h2>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Users\umaru\OneDrive\Documents\Budiluhur\studpen\it-perbankan-finpro-kelompok10\web\e-bank-laravel\resources\views/saldo.blade.php ENDPATH**/ ?>
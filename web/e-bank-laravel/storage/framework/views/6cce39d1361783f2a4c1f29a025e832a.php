        ...
        <div class="menu-dashboard">
          ...
          <form action="<?php echo e(route('simpan_profil')); ?>" method="post">
            ...
            <div class="profile item2">
              <div>
                <h2>First Name</h2>
                <input name="first-name" type="text" name="firstname" value="<?php echo e($firstName); ?>" />
              </div>
              <div>
                <h2>Last Name</h2>
                <input name="last-name" type="text" name="lastname" value="<?php echo e($lastName); ?>" />
              </div>
            </div>
            <div class="profile item2">
              <div>
                <h2>Username</h2>
                <input name="username" type="text" name="username" value="<?php echo e(session()->get('username')); ?>" />
              </div>
              <div>
                <h2>Email</h2>
                <input name="email" type="email" name="email" value="<?php echo e(session()->get('email')); ?>" />
              </div>
            </div>
            <div class="profile item2">
              <div>
                <h2>Phone Number</h2>
                <input name="no-hp" type="number" name="firstName" value="<?php echo e($bank->no_hp); ?>" />
              </div>
              <div>
                <h2>City</h2>
                <input name="city" type="text" name="lastName" value="<?php echo e($bank->kota); ?>" />
              </div>
            </div>
            <div class="profile item3">
              <div>
                <h2>Address</h2>
                <input name="address" type="text" name="address" value="<?php echo e($bank->alamat); ?>" />
              </div>
...
<?php /**PATH C:\Users\umaru\OneDrive\Documents\Budiluhur\studpen\it-perbankan-finpro-kelompok10\web\e-bank-laravel\resources\views/profil.blade.php ENDPATH**/ ?>
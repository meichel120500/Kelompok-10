  ...
  <body>
    <div class="form-login">
      <div class="login-card">
        ...
        <form action="<?php echo e(route('submit_login')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <!-- konten 1 -->
            <div class="content-1">
        ...
        <div class="content-5">
          ...
          <a href="<?php echo e(route('sign_up')); ?>">Sign Up</a>
        </div>
      </div>
    </div>
  </body>
</html>
<?php /**PATH C:\Users\umaru\OneDrive\Documents\Budiluhur\studpen\it-perbankan-finpro-kelompok10\web\e-bank-laravel\resources\views/login.blade.php ENDPATH**/ ?>